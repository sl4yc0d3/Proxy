...
/*
   ...
   |  Script         | PHProxy                                                    |
   |  Author         | Sl4yc0d3                                              |
   |  Last Modified  | 5:27 PM 1/21/2012                                          |
   +-----------------+------------------------------------------------------------+
...
else
{
    ...
    {
        $_url_form      = '<div style="width:100%;margin:0;text-align:center;border-bottom:1px solid #ffffff;color:#000000;background-color:#E1E1E0;font-size:12px;font-weight:bold;font-family:Bitstream Vera Sans,arial,sans-serif;padding:4px;">'
